...
class UserRegistrationController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('UserRegistration');
	...
	{
		$model=new UserRegistration('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['UserRegistration']))
			$model->attributes=$_GET['UserRegistration'];
	...
	{
		$model=UserRegistration::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param UserRegistration $model the model to be validated
	 */
