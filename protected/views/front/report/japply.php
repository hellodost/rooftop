<script type="text/javascript" src="<?php echo Yii::app()->baseurl; ?>/js/jquery.battatech.excelexport.js"></script>
<?php
$data = FUsers::model()->userLevel();
$name = $data['name'];
$userid = $data['userid'];
$div = $data['div'];
?>
...
if (isset($_POST['mandal']) && $_POST['mandal'] > 0 && $_POST['mandal'] != "") {
    $mandal = $_POST['mandal'];
}

$dt = '';
if (isset($_POST['bgtdate']))
    $dt = 'and rel_date =' . $_POST['bgtdate'];

$yr = FUsers::model()->getYear();
$yr2 = 0;
if (isset($_POST['yr']) && $_POST['yr'] > 0 && $_POST['yr'] != "") {
    $yr = $_POST['yr'];
}
$yr2 = $yr + 1;

$mandal = FBoards::model()->findAll();
?>
<div id="content">
