    	...
    	<div class="header">
            ...
            <div class="nav">
            	<ul>
                    ...
                    <li><a href="<?php echo Yii::app()->createUrl('job-search'); ?>">Exams search</a></li>
                    <li><a href="<?php echo Yii::app()->createUrl('post-resume'); ?>">Post resume</a></li>
                    <li><a href="<?php echo Yii::app()->createUrl('career'); ?>">Carear services</a></li>
   ...
   <div class="searh_row_con">
       <div class="searh_row">
        <div class="search_con">
            ...
            <strong>Search Job</strong><input name="search_txt" type="text" placeholder="Skill,Keword,Company name " class="fld" />
